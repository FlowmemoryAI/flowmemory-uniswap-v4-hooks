...
class FlowMemoryReleaseTranscriptTest(unittest.TestCase):
    ...
    def test_transcript_includes_required_evidence_layers(self):
        ...
        self.assertIn("Compute ChargeLine", local_names)
        self.assertIn("DischargeLine Harness", local_names)
        ...
        self.assertIn("PulseWatch 24/7 Reader", local_names)
        self.assertIn("Receipt Runtime MVP", local_names)
    ...
    def test_demo_output_is_screenshot_ready(self):
        ...
        self.assertIn("PulseWatch 24/7 Reader", completed.stdout)
        self.assertIn("Receipt Runtime MVP", completed.stdout)
