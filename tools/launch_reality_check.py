...
REQUIRED_FILES = [
    ...
    "specs/ComputeChargeLine.v0.md",
    "specs/DischargeLine.v0.md",
    "specs/SpendLine.v0.md",
    "specs/DuplexLine.v0.md",
    "specs/AgentCommerceConservation.v0.md",
    "specs/ObligationMembrane.v0.md",
    "specs/AgentCommerceDifferential.v0.md",
    ...
    "examples/compute-chargeline/expected-output.txt",
    "examples/dischargeline/expected-output.txt",
    "examples/spendline/expected-output.txt",
    "examples/duplexline/expected-output.txt",
    "examples/agent-commerce-conservation/expected-output.txt",
    "examples/obligation-membrane/expected-output.txt",
    "examples/agent-commerce-differential/README.md",
    "examples/agent-commerce-differential/differential-cases.json",
    "examples/agent-commerce-differential/expected-output.txt",
...
RUNTIME_LINES = [
    ...
    "Compute ChargeLine: compute payment follows the memory-consistent compute route",
    "DischargeLine: settlement is not obligation discharge",
    "SpendLine: memory-linearizable autonomous spend histories",
    "DuplexLine: co-serializable buyer/seller agent exchange",
    "Agent Commerce Conservation: obligation conservation across spend, work, compute, refusal, and memory",
    "Obligation Membrane: no obligation laundering through subagents, compute providers, or aggregate work",
    "Agent Commerce Differential: ordinary rails accept, FlowMemory rejects impossible histories",
